...
<body>
	...
	<div>
		<input type="text" id="name" /> <br /> <input type="number" id="age" />
		<br /> <input type="button" id="GET" value="GET" /> <br /> <input
			type="button" id="POST" value="POST" /> <br /> <input type="button"
			id="PUT" value="PUT" /> <br /> <input type="button" id="xmlTest"
			value="xml Test" /> <br /> <input type="button" id="xmlJSON"
			value="xml JSON" /> <br />
	</div>
